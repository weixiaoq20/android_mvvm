...
public class LoginChannelModel extends BaseMvvmModel<NewsChannelsBean, List<NewsChannelsBean.ChannelList>> {
    ...
    public LoginChannelModel() {
        super(false, "NEWS_CHANNEL_PREF_KEY", null);
    }
