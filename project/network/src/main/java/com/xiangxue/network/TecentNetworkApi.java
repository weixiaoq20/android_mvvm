...
public class TecentNetworkApi extends NetworkApi {
    ...
    public static String mBaseUrl="http://service-o5ikp40z-1255468759.ap-shanghai.apigateway.myqcloud.com/";
    ...
    public static  <T> T getService(Class<T> service,String url) {
        mBaseUrl=url;
